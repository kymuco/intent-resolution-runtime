...
**M2.4 — Attempt / Outcome / Continuation Orchestrator** is the current milestone. It derives exact attempt/outcome history, explicit continuation-source selection, Host re-entry state, and successor-lineage consumption without collapsing Outcome dimensions or adding retry, fallback, recovery, branch-selection, or parent-completion policy.
